...
export default function AdminComunicadosTab() {
  const {
    ...
    editGrupoId, grupoNome, setGrupoNome,
    ...
    addFiltroSimple, confirmPlanFilter, confirmCidadeFilter, handleApplyFilters,
    handleSaveGrupo, handleDeleteGrupo,
    openNovoComunicado,
    handlePrepararEnvio, handleEnviar,
  } = useAdminComunicados();
      ...
      <div className="p-6 max-w-5xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 items-start">
          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-2 pt-2 border-t">
              <Button
                onClick={() => handlePrepararEnvio(isEditorEmpty)}
