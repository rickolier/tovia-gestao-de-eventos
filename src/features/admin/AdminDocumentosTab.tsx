...
const DOCS: Doc[] = [
  ...
  },
  {
    ...
    description: '75+ erros mapeados com códigos públicos (TV001…) e internos. 212 testes passando.',
  ...
  },
  {
    id: 'backlog',
    title: 'Backlog Tovia',
    description: 'Pendências ativas: bugs, infra, produto, segurança, crescimento e escala. 22 itens (17 resolvidos).',
