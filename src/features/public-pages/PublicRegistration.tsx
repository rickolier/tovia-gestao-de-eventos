...
import { Cupom, Evento, Ticket } from '~/types';
import { Tag, X, Loader2 } from 'lucide-react';
import { useRegistrationFlow, RegistrationFlowProps } from './hooks/useRegistrationFlow';
...
function RegistrationFlow({ eventoId, initialEvento, isSimulation = false }: RegistrationFlowProps) {
  const {
    ...
    handlePaymentSubmit,
  } = useRegistrationFlow({ eventoId, initialEvento, isSimulation });
