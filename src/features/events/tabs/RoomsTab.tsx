...
import { useRooms, Divisao, TIPOS_GRUPO, LIMITE_DIVISOES, getLabelForDivisao, emptyNovaDivisao } from './hooks/useRooms';
...
export default function RoomsTab({ eventoId }: { eventoId: string }) {
  const {
    divisoes, activeDivisaoId, setActiveDivisaoId,
    rooms, registrations,
