        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {STEPS.map(({ step, title, desc, Anim }) => (
            ...
            >
              ...
              <h3 className="text-xl font-black text-white leading-tight mb-2 md:max-w-[58%]">{title}</h3>
              <p className="text-xs text-white/50 leading-relaxed md:max-w-[55%] mb-4 md:mb-0">{desc}</p>
              <div className="flex md:absolute md:bottom-0 md:right-4 items-end justify-center md:justify-end mt-auto">
                <Anim />
              </div>
            </div>
          ))}
