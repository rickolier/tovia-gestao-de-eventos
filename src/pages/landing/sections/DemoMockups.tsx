          ...
          <div className="flex-1 max-w-md">
            {demoTab === 'vendas' && (
              <div>
                ...
                <h3 className="text-2xl font-black text-white mb-4">Páginas de Inscrição prontas para compartilhar</h3>
            ...
            {demoTab === 'tarefas' && (
              <div>
                ...
                <h3 className="text-2xl font-black text-white mb-4">Gestão de Tarefas da Equipe</h3>
                <p className="text-white/65 leading-relaxed mb-6">
