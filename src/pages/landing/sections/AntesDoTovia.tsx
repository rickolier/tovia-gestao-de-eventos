          ...
          <div className="relative min-h-[420px] flex items-center justify-center">
            ...
            {DORES.map(({ icon: Icon, label }, i) => {
              ...
              return (
                <div
                  key={label}
                  className="absolute flex items-center gap-1.5 sm:gap-2 bg-primary/90 backdrop-blur-md border border-white/20 shadow-lg rounded-full px-2 py-1.5 sm:px-3 sm:py-2 animate-pulse"
                  style={{
                    top: pos.top,
                ...
                >
                  ...
                  <span className="text-[10px] sm:text-xs font-semibold text-white whitespace-nowrap">{label}</span>
                </div>
              );
            })}
          </div>
