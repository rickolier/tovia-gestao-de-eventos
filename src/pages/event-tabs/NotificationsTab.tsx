...
export default function NotificationsTab({ eventoId }: NotificationsTabProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-black text-foreground tracking-tight">Notificações do Evento</h1>
        <p className="text-muted-foreground">Gerencie aprovações e avisos deste evento.</p>
      </div>
