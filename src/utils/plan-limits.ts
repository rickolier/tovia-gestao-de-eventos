...
export const PLAN_CONFIGS: Record<PlanLevel, PlanConfig> = {
  ...
  petach: {
    ...
    price: {
      monthly: 39,
      annual: 390,
      monthlyLabel: 'R$ 39/mês',
      annualMonthLabel: 'R$ 32,50/mês',
      annualTotalLabel: 'R$ 390/ano',
    },
    modulesCount: 2,
  ...
  koach: {
    ...
    price: {
      monthly: 99,
      annual: 990,
      monthlyLabel: 'R$ 99/mês',
      annualMonthLabel: 'R$ 82,50/mês',
      annualTotalLabel: 'R$ 990/ano',
    },
    modulesCount: 3,
  ...
  chalem: {
    ...
    price: {
      monthly: 249,
      annual: 2490,
      monthlyLabel: 'R$ 249/mês',
      annualMonthLabel: 'R$ 207,50/mês',
      annualTotalLabel: 'R$ 2.490/ano',
    },
    modulesCount: 4,
